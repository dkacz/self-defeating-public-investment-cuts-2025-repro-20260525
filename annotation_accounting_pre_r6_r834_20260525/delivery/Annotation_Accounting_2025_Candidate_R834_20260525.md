# Rozliczenie anotacji po przebudowie notebooka i tabel 2025
...
Po najnowszej przebudowie mamy 40 pozycji do rozliczenia: 24 pozycji jest ponownie otwartych, a 16 można przenieść tylko po świeżej kontroli punktowej.
...
## Co dokładnie ma sprawdzić Pro

- czy obecny tekst odpowiada na dawne anotacje po zmianie liczb;
- czy Appendix D jasno wyjaśnia p-wartości, zakres niepewności i brak pełnych pasm dla całych ścieżek;
- czy Irlandia jest utrzymana wszędzie tam, gdzie ma dane, a braki finansowe nie skracają innych szeregów;
- czy TiVA pozostaje na danych oficjalnych bez dorabiania lat po 2022 roku;
- czy każda materialna liczba w artykule ma jawny ślad w granularnym notebooku;
- czy średnia equal-weight dla odpowiedzi jest średnią trzech polskich ścieżek, bez EU27 benchmarku;
- czy bieżące tabele artykułu nie zawierają starych plików, które przeczą obecnemu notebookowi;
- czy cała estymacja jest w notebooku widoczna małymi krokami, a nie ukryta w skrypcie pomocniczym ani w jednej długiej komórce;
- czy każdy ważny krok notebooka jest opisany w artykule, appendixie albo dokumencie odtwarzalności.
