...
## Pozycje dotkniete zmiana tekstu lub liczby

### 1. Abstract mocniej pokazuje paradoks wyniku

**Status:** sprawdzone w obecnej wersji 2025; bez wymaganej zmiany. Zakres kontroli: zmiana tekstu lub liczby.
...
Ten fragment wymagal ponownego sprawdzenia, bo zmiana danych, liczb albo powierzchni artykulu mogla uniewaznic starsza odpowiedz. Obecna wersja nie wymaga zmiany.

**Wynik obecnej kontroli:**

Obecna wersja 2025 nie wymaga zmiany; pozycja zostaje w rozliczeniu jako zapis sprawdzonej uwagi.
...
### 8. Kolejność Appendix D pozostaje decyzją autorska
